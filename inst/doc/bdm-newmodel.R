...
## ----newhist, fig.cap='Posterior histogram plots for chatham rise hake fit using the new non-default model'----
histplot(mdl,par = c('r','logK','sigmap2'))

## ----newtrace, fig.cap='Catchability trace plots plots for chatham rise hake fit using the new non-default model'----
traceplot(mdl,par = 'q')
