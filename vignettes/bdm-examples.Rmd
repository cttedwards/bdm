...
This currently represents a standard application, but in some situations it may be necessary to modify the model itself. For example, we might want to create a model that estimates the process error. This is illustrated here using the same Orange Roughy example.
